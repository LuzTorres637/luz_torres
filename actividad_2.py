...
#Calcula la suma de todos los elementos en un array de NumPy de tamaño 10x10, lleno de unos.    
   ...
   #Dados dos arrays de tamaño 5, llenos de números aleatorios desde 1 hasta 10, realiza un producto elemento a elemento
    ...
    def punto_3(self):
        ...
        self.df["# ejercicio"]= 3
        self.df["valor"]= str(array_5_1*array_5_2)
        self.df.to_excel("Actividad_2.xlsx")
    ...
    def punto_4(self):
        ...
        try:
            ...
            self.df.to_excel("Actividad_2.xlsx", index=False)
        except np.linalg.LinAlgError:
            self.df["# ejercicio"] = 4
            self.df["valor"] = "La matriz no tiene inversa (es singular)."
    ...
    def punto_6(self):
        ...
        self.df["# ejercicio"] = 6
        self.df["valor"] = [array_3x1, array_1x3, suma]
        self.df.to_excel("Actividad_2.xlsx")
    ...
    def punto_7(self):
        ...
        self.df["# ejercicio"] = 7
        self.df["valor"] = [matriz, submatriz]
        self.df.to_excel("Actividad_2.xlsx")
    ...
    def punto_9(self):
        ...
        self.df["# ejercicio"] = 9
        self.df["valor"] = [matriz, matriz_invertida]
        self.df.to_excel("Actividad_2.xlsx")
    ...
    def punto_10(self):
        ...
        self.df["valor"] = [array_aleatorio, array_mayores_05]
        self.df.to_excel("Actividad_2.xlsx")
